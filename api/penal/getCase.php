...
try {
    ...
    if ($documentoInicial !== null) {
        $documentoInicial['id'] = isset($documentoInicial['id']) ? (int) $documentoInicial['id'] : null;
        $documentoInicial['tamano_bytes'] = isset($documentoInicial['tamano_bytes']) ? (int) $documentoInicial['tamano_bytes'] : null;
        $documentoInicial['documento_tipo'] = 'ASUNTO';
    }
    ...
    $case['documento_inicial_observaciones'] = $documentoInicial['observaciones'] ?? '';
