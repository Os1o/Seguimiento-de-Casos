...
try {
    ...
    if (!$seguimientoStmt->fetch()) {
        sendError('El seguimiento no corresponde al expediente indicado', 400);
    }

    $storageDir = getStorageBasePath() . DIRECTORY_SEPARATOR . 'documentos' . DIRECTORY_SEPARATOR . 'civil' . DIRECTORY_SEPARATOR . $expedienteId;
    ...
    $rutaRelativa = 'storage/documentos/civil/' . $expedienteId . '/' . $nombreGuardado;
